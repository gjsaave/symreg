...
parser.add_argument('--num_train_bag', type=int, default=8, help='num subset of training points to use for this model')
parser.add_argument('--bag_seed', type=int, default=0, help='seed for subset bag chosen')
...
num_train_bag = args.num_train_bag
...
bag_indices = np.random.choice(list(range(len(data_train))), size=num_train_bag, replace=True)
data_train = data_train[bag_indices]
data_train_labels = data_train_labels[bag_indices]
