...
def get_results(seeds, nngens, param_name, params, pc, psm, ppm, generations, nt):
    ...
    for param in params:
        ...
        for nngen in nngens:
            perf_per_seed = []
            for seed in seeds:
                exp_filepath = "/Users/garysaavedra/exp_output/symreg/exp00004_symreg_nn_fuzz/sd" + str(seed) + "rk1_nt" + str(nt) + "_nv100_ep1_pop" + str(param) + "_pc" + str(pc) + "_psm" + str(psm) + "_ppm" + str(ppm) + "_nf1_gen" + str(generations) + "_ng" + str(nngen) +  "/output"
